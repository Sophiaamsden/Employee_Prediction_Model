...
```{r}
library(tree)
EmployeePerformance <- read_excel("C:/Users/Lenovo/Downloads/EmployeePerformance.xlsx")
...
```{r}
library(readxl)
EmployeeAttrition <- read_excel("C:/Users/Lenovo/Downloads/EmployeeAttrition.xlsx")
